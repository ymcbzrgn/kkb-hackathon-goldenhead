"""
News Agent Logger - Kapsamli logging icin yardimci.
Her adimi takip etmek, sonsuz donguler tespit etmek icin.

TSG Logger'dan adapte edilmistir.
"""
import time
import asyncio
...
class NewsLogger:
    """News Agent icin merkezi logger."""
...
# Kisa alias'lar
log = NewsLogger.log
step = NewsLogger.step
success = NewsLogger.success
error = NewsLogger.error
warn = NewsLogger.warn
debug = NewsLogger.debug
